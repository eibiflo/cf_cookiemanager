...
CREATE TABLE tx_cfcookiemanager_domain_model_cookiefrontend (
    ...
    impress_link varchar(255) NOT NULL DEFAULT '',
    impress_text varchar(255) NOT NULL DEFAULT '',
    data_policy_link varchar(255) NOT NULL DEFAULT '',
    data_policy_text varchar(255) NOT NULL DEFAULT '',
	custombutton smallint(1) unsigned NOT NULL DEFAULT '0',
	custom_button_html text NOT NULL,
