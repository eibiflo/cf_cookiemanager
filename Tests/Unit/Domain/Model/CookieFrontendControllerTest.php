...
{
    /**
     * @var \CodingFreaks\CfCookiemanager\Domain\Model\CookieFrontendController|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \CodingFreaks\CfCookiemanager\Domain\Model\CookieFrontendController::class,
            ['dummy']
        );
    }
