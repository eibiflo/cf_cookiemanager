    ...
    var CookieConsent = function(root){
        ...
        var _createSettingsModal = function(lang){
            ...
            for(var ii=0; ii<n_categories; ++ii) {
                ...
                block_title_container2.className = 'titlecategory';
                block_section2.className = 'block-section';
                block_table_container2.className = 'desc';



                var block_desc2 = _createNode('div');
                block_desc2.className = 'cf-category-description';
                block_desc2.insertAdjacentHTML('beforeend', categories[ii]["description"]);
                ...
                if(true){
                    ...
                    block_switch_label2.className = 'expand-button-cfwrapper b-tg';
                    block_switch2.className = 'expand-button '; //c-tgl
            ...
            for(var i=0; i<n_blocks; ++i){
                ...
                if(toggle_data && title_data || (!toggle_data && (title_data || description_data))){
                    ...
                    for(var iii=0; iii< cf_category_list_full.length; ++iii) {
                      ...
                      //      console.log(cf_category_list_full[iii].children[1]);
                    ...
                    for(var iiii=0; iiii<cf_category_list_full.length; ++iiii) {
                      //  console.log(cf_category_list_full[iiii]);
            ...
            if(document.contains){
                _addEvent(main_container, 'click', function(e){
                    ...
                    if(_hasClass(e.target,"c-tgl")){
                       /* console.log("Switch Service"+e.target.value); */
