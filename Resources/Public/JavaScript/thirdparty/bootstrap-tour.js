...
export default Tour;
    ...
    function Tour(options) {
        ...
        this._options = $.extend({
            ...
            delay: false,
            basePath: '',
            template: '<div class="popover" role="tooltip"> <div class="popover-arrow"></div> <h3 class="popover-header"></h3> <div class="popover-body"></div> <div class="popover-navigation"><div class="btn-group"> <a class="btn btn-sm btn-secondary data-role-prev" data-role="prev">&laquo; Prev</a> <a class="btn btn-sm btn-secondary data-role-next" data-role="next">Next &raquo;</a> <a class="btn btn-sm btn-secondary data-role-resume" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</a> </div> <a class="btn btn-sm btn-secondary data-role-end" data-role="end">End tour</a> </div> </div>',
    ...
    Tour.prototype._template = function(step, i) {
        ...
        $resume = $navigation.find('.data-role-resume');
        ...
        for (j = 0, len = ref.length; j < len; j++) {
            ...
            switch (pos) {
                ...
                case 'bottom':
                    ...
                    $backdrop.html("<div class='force-end-tour'><p>Stop the Tour</p></div>");
                    break;
                case 'left':
                    results.push($backdrop.offset({
                        top: data.offset.top,
